...
public class CapitalFirstAgentPage extends BasePage {
	...
	WebElement cflRadioButton;

	@FindBy(xpath = "//label[@for='merchantId-female']")
	WebElement hfcRadioButton;
	...
	@FindBy(xpath = "//capital-first-collection/div//button[contains(text(),'Submit')]")
	...
	public void capitalFirstAgent(Map<String, String> usrData)
