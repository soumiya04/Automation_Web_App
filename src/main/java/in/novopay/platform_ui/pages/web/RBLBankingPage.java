...
public class RBLBankingPage extends BasePage {
	...
	@FindBy(xpath = "//input[@name='aeps-deposit-aadhar-number']")
	...
	@FindBy(xpath = "//span[contains(text(),'Cash Withdrawal')]")
	...
	@FindBy(xpath = "//div[contains(@class, 'aadhaar__input--group')]//input[@id='rbl-withdrawal-aadharNumber']")
		WebElement withdrawalAadhaarNum;
	...
	@FindBy(xpath = "//input[@id='rbl-balEnq-aadharNumber']")
	WebElement balanceEnquiryAadhaarNum;
	...
	@FindBy(xpath = "//div[contains(@class, 'aadhaar__input--group')]//input[@id='rbl-miniStatement-aadharNumber']")
	...
	public void depositTxns(Map<String, String> usrData, double walletBalance)
		...
		withdrawalMobNum.sendKeys(Keys.TAB);
		waitUntilElementIsVisible(withdrawalAmount);
	...
	public void withdrawalTxns(Map<String, String> usrData, double walletBalance)
		...
		System.out.println("Banking (AEPS) tab");
