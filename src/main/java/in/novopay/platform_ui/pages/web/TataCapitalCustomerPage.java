   ...
   @FindBy(xpath = "//*[@class='fa fa-bars fa-lg text-white']")
	...
	WebElement pageTitle;
	 ...
	 WebElement contractNo;
       ...
       @FindBy(xpath ="//div[@class='btn-actions ']//button[@class='button button-primary mar-3 proceed-btn' and text()=' Proceed ']")
	...
	WebElement amountToPay;
       ...
       @FindBy(xpath ="//button[@type='submit' and contains(@class, 'proceed-btn')]")
       WebElement proceed3;
	...
	throws InterruptedException, AWTException, IOException, ClassNotFoundException {
		...
		try {
			...
			System.out.println("Cash Service icon clicked");
