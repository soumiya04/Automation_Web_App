...
public class LoadMoneyNowPage extends BasePage {
	...
	@FindBy(xpath ="//input[@aria-autocomplete='list' and @type='text']")
	WebElement paymentDropdown1;
	...
	@FindBy(xpath="//ng-select[@id='bank-search-list']//input[@type='text']")
	...
	@FindBy(xpath = "//span[contains(@class, 'ng-option-label') and text() = 'Net banking']")
	...
	WebElement okButton;
	 ...
	 // @FindBy(xpath = "//div[@role='listbox']//div[@class='ng-option ng-star-inserted'][2]//span[text()='Net banking']")
	  @FindBy(xpath = "//ng-select[@id='bank-search-list']//input[@type='text']")
	  WebElement netBankingOption1;
	...
	public void loadMoneyNow(Map<String, String> usrData)
		...
		try {
			...
			Thread.sleep(1000);
			//select payment mode
		waitUntilElementIsClickableAndClickTheElement(netBankingOption);
		...
		/*	String typeXpath = "//*[contains(@id,'select2')]/li[contains(text(),'" + usrData.get("MODEOFPAYMENT")
			...
			String typeXpath = "//span[contains(@class, 'ng-option-label') and text() ='"+ usrData.get("MODEOFPAYMENT")
			+ "')]";
				waitUntilElementIsClickableAndClickTheElement(wdriver.findElement(By.xpath(typeXpath)));
	System.out.println(usrData.get("MODEOFPAYMENT") + " selected");*/
			...
			if (usrData.get("MODEOFPAYMENT").equalsIgnoreCase("Net banking")) {
				...
				String bank = "//span[@class='ng-option-label' and text()='" + usrData.get("BANK") + "']";
