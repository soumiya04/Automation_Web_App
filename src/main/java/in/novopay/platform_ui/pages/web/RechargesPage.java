...
public class RechargesPage extends BasePage {
	...
	@FindBy(xpath = "//label[@for='postpaid']")
	...
	@FindBy(xpath = "//span[@class='ng-arrow-wrapper']/span[@class='ng-arrow']")
	WebElement mobileOperator;

	//@FindBy(xpath = "//input[@class='select2-search__field']")
	@FindBy(xpath ="//input[@type='text' and @aria-autocomplete='list']")
	...
	@FindBy(xpath ="//label[contains(text(),'Customer Id')]/following-sibling::div/input[@type='text']")
	WebElement dthId;
	...
	@FindBy(xpath ="//input[@formcontrolname='handleValue' and @type='tel' and @placeholder='eg: 9999999999']")
	...
	public void recharges(Map<String, String> usrData)
		...
		try {
			...
			//commonUtils.Novopayvisible(recharges, novopayHomePage);
	...
	System.out.println("Clicked on Operator dropdown");
                         ...
                         // waitUntilElementIsClickableAndClickTheElement(airtelOperator);
                                //      System.out.println("Operator selected");
		
		waitUntilElementIsClickableAndClickTheElement(dropdownField);
		System.out.println("Dropdown field clicked");
		...
		dropdownField.sendKeys(usrData.get("OPERATOR"));
			...
			dropdownField.sendKeys(Keys.TAB);
