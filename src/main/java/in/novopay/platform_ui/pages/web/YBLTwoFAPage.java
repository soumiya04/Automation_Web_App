...
public class YBLTwoFAPage extends BasePage {
	...
	WebElement DoneButton;
    	...
    	// Load all objects
    	public YBLTwoFAPage(WebDriver wdriver) {
    		super(wdriver);
    		PageFactory.initElements(wdriver, this);
    	}
            // Perform action on page based on given commands
    	public void yblTwofa(Map<String, String> usrData)
    			 ...
    			 commonUtils.displayInitialBalance("retailer"); // display main wallet balance
    				commonUtils.displayInitialBalance("cashout"); // display cashout wallet balance
    				 ...
    				 waitUntilElementIsClickableAndClickTheElement(withdrawalTab);
    	                withdrawalTab.click();
    	                 System.out.println("YBL Banking withdrawal option clicked");
