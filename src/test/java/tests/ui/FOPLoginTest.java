...
import in.novopay.platform_ui.pages.web.FOPLoginPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class FOPLoginTest {
	String featureName = "FOP Login page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private FOPLoginPage wFOPLoginPage;
	private Map<String, String> usrData;
	public String sheetname = "FOPLoginPage", workbook = "WebAppUITestData";
	...
	public void fOPLoginTest(HashMap<String, String> usrData)
			throws InterruptedException, AWTException, IOException, ClassNotFoundException {
		this.usrData = usrData;
		if (wdriver == null) {
			System.out.println("LAUNCHING THE WEB APP FOR FLOW : " + usrData.get("TCID"));
			mBasePage.launchBrowser();
		} else if ((wdriver != null)) {
			System.out.println("LAUNCHING THE WEB APP FOR FLOW : " + usrData.get("TCID"));
		}

		wFOPLoginPage = new FOPLoginPage(wdriver);
		wFOPLoginPage.fOPLoginPage(usrData);
	}
