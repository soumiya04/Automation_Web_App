...
import in.novopay.platform_ui.pages.web.EZYPAYDmtPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class EZYPAYDmtTest {
	String featureName = "Ezpay dmt page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private EZYPAYDmtPage wEZYPAYDmtPage;
	private Map<String, String> usrData;
	public String sheetname = "EZYPAYDmtPage", workbook = "WebAppUITestData";
	...
	public void eZYPAYDmtTest(HashMap<String, String> usrData)
		...
		wEZYPAYDmtPage = new EZYPAYDmtPage(wdriver);
		wEZYPAYDmtPage.ezypayDmt(usrData);
	}
