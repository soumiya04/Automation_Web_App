...
import in.novopay.platform_ui.pages.web.CapitalFirstAgentPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class CapitalFirstAgentTest {
	String featureName = "Capital First Agent page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private CapitalFirstAgentPage wCapitalFirstAgentPage;
	private Map<String, String> usrData;
	public String sheetname = "CapitalFirstAgentPage", workbook = "WebAppUITestData";
	...
	public void capitalFirstAgentTest(HashMap<String, String> usrData)
		...
		wCapitalFirstAgentPage = new CapitalFirstAgentPage(wdriver);
		wCapitalFirstAgentPage.capitalFirstAgent(usrData);
	}
