...
public class RBLStatusEnquiryTest {
	...
	private RBLStatusEnquiryPage wRBLStatusEnquiryPage;
	private Map<String, String> usrData;
	public String sheetname = "RBLStatusEnquiryPage", workbook = "WebAppUITestData";
	...
	public void rBLStatusEnquiryTest(HashMap<String, String> usrData)
		...
		wRBLStatusEnquiryPage = new RBLStatusEnquiryPage(wdriver);
		wRBLStatusEnquiryPage.rBLStatusEnquiry(usrData);
	}
