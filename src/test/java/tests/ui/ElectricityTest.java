...
import in.novopay.platform_ui.pages.web.ElectricityPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class ElectricityTest {
	String featureName = "Electricity page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private ElectricityPage wElectricityPage;
	private Map<String, String> usrData;
	public String sheetname = "ElectricityPage", workbook = "WebAppUITestData";
	...
	public void electricityTest(HashMap<String, String> usrData)
		...
		wElectricityPage = new ElectricityPage(wdriver);
		wElectricityPage.electricity(usrData);
	}
