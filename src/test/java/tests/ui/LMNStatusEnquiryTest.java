...
import in.novopay.platform_ui.pages.web.LMNStatusEnquiryPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class LMNStatusEnquiryTest {
	String featureName = "Load Money Now Status Enquiry page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private LMNStatusEnquiryPage wLoadMoneyNowStatusEnquiryPage;
	private Map<String, String> usrData;
	public String sheetname = "LMNStatusEnquiryPage", workbook = "WebAppUITestData";
	...
	public void lMNStatusEnquiryTest(HashMap<String, String> usrData)
		...
		wLoadMoneyNowStatusEnquiryPage = new LMNStatusEnquiryPage(wdriver);
		wLoadMoneyNowStatusEnquiryPage.lMNStatusEnquiry(usrData);
	}
