...
import in.novopay.platform_ui.pages.web.RechargesPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class RechargesTest {
	String featureName = "Recharges page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private RechargesPage wRechargesPage;
	private Map<String, String> usrData;
	public String sheetname = "RechargesPage", workbook = "WebAppUITestData";
	...
	public void rechargesTest(HashMap<String, String> usrData)
		...
		wRechargesPage = new RechargesPage(wdriver);
		wRechargesPage.recharges(usrData);
	}
