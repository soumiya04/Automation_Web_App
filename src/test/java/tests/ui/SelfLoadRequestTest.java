...
public class SelfLoadRequestTest {
	String featureName = "Self Load Request page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private SelfLoadRequestPage wSelfLoadRequestPage;
	private Map<String, String> usrData;
	public String sheetname = "SelfLoadRequestPage", workbook = "WebAppUITestData";
	...
	public void selfLoadRequestTest(HashMap<String, String> usrData)
		...
		wSelfLoadRequestPage = new SelfLoadRequestPage(wdriver);
		wSelfLoadRequestPage.selfLoadRequest(usrData);
	}
