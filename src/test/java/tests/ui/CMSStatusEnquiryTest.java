...
import in.novopay.platform_ui.pages.web.CMSStatusEnquiryPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class CMSStatusEnquiryTest {
	String featureName = "CMS Status Enquiry page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private CMSStatusEnquiryPage wCMSStatusEnquiryPage;
	private Map<String, String> usrData;
	public String sheetname = "CMSStatusEnquiryPage", workbook = "WebAppUITestData";
	...
	public void cMSStatusEnquiryTest(HashMap<String, String> usrData)
		...
		wCMSStatusEnquiryPage = new CMSStatusEnquiryPage(wdriver);
		wCMSStatusEnquiryPage.cmsStatusEnquiry(usrData);
	}
