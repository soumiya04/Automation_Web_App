...
import in.novopay.platform_ui.pages.web.RechargesStatusEnquiryPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class RechargesStatusEnquiryTest {
	String featureName = "Recharges Status Enquiry page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private RechargesStatusEnquiryPage wRechargesStatusEnquiryPage;
	private Map<String, String> usrData;
	public String sheetname = "RechargesStatusEnquiryPage", workbook = "WebAppUITestData";
	...
	public void rechargesStatusEnquiryTest(HashMap<String, String> usrData)
		...
		wRechargesStatusEnquiryPage = new RechargesStatusEnquiryPage(wdriver);
		wRechargesStatusEnquiryPage.rechargesStatusEnquiry(usrData);
	}
