...
import in.novopay.platform_ui.pages.web.CapitalFirstConsumerPage;
import in.novopay.platform_ui.pages.web.TataCapitalCustomerPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class TataCapitalCustomerTest {
	String featureName = "Tata Capital Customer page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private TataCapitalCustomerPage wTataCapitalCustomerPage;
	private Map<String, String> usrData;
	public String sheetname = "TataCapitalCustomerPage", workbook = "WebAppUITestData";
	...
	public void tataCapitalCustomerTest(HashMap<String, String> usrData)
		...
		wTataCapitalCustomerPage = new TataCapitalCustomerPage(wdriver);
		wTataCapitalCustomerPage.tataCapitalCustomer(usrData);
	}
