...
import in.novopay.platform_ui.pages.web.SettlementStatusEnquiryPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class SettlementStatusEnquiryTest {
	String featureName = "Settlement Status Enquiry page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private SettlementStatusEnquiryPage wSettlementStatusEnquiryPage;
	private Map<String, String> usrData;
	public String sheetname = "SettlementStatusEnquiryPage", workbook = "WebAppUITestData";
	...
	public void settlementStatusEnquiryTest(HashMap<String, String> usrData)
		...
		wSettlementStatusEnquiryPage = new SettlementStatusEnquiryPage(wdriver);
		wSettlementStatusEnquiryPage.settlementStatusEnquiry(usrData);
	}
