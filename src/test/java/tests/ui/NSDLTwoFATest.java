...
import in.novopay.platform_ui.pages.web.NSDLTwoFAPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class NSDLTwoFATest {

	String featureName = "Nsdl 2FA page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
    private NSDLTwoFAPage wNSDLTwoFAPage;
    private Map<String, String> usrData;
	public String sheetname = "NsdlTwoFAPage", workbook = "WebAppUITestData";
	...
	public void nSDLTwoFATest(HashMap<String, String> usrData)throws InterruptedException, AWTException, IOException, ClassNotFoundException {
		...
		wNSDLTwoFAPage = new NSDLTwoFAPage(wdriver);
		wNSDLTwoFAPage.nsdlTwofa(usrData);
	}
	@DataProvider
