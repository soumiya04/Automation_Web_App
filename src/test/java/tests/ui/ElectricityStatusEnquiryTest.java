...
public class ElectricityStatusEnquiryTest {
	...
	private ElectricityStatusEnquiryPage wElectricityStatusEnquiryPage;
	private Map<String, String> usrData;
	public String sheetname = "ElectricityStatusEnquiryPage", workbook = "WebAppUITestData";
	...
	public void electricityStatusEnquiryTest(HashMap<String, String> usrData)
		...
		wElectricityStatusEnquiryPage = new ElectricityStatusEnquiryPage(wdriver);
		wElectricityStatusEnquiryPage.electricityStatusEnquiry(usrData);
	}
