...
import in.novopay.platform_ui.pages.web.TataCapitalAgentPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class TataCapitalAgentTest {
	String featureName = "TataCapital Agent page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private TataCapitalAgentPage wTataCapitalAgentPage;
	private Map<String, String> usrData;
	public String sheetname = "TataCapitalAgentPage", workbook = "WebAppUITestData";
	...
	public void tataCapitalAgentTest(HashMap<String, String> usrData)
		...
		wTataCapitalAgentPage = new TataCapitalAgentPage(wdriver);
		wTataCapitalAgentPage.tataCapitalAgent(usrData);
	}
