...
import in.novopay.platform_ui.pages.web.RBLBankingPage;
...
public class RBLBankingTest {
	...
	private RBLBankingPage wRBLBankingPage;
	private Map<String, String> usrData;
	public String sheetname = "RBLBankingPage", workbook = "WebAppUITestData";
	...
	public void rBLBankingTest(HashMap<String, String> usrData)
		...
		wRBLBankingPage = new RBLBankingPage(wdriver);
		wRBLBankingPage.rblBanking(usrData);
	}
