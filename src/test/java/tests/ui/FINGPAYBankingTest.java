...
import in.novopay.platform_ui.pages.web.FINGPAYBankingPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class FINGPAYBankingTest {
	String featureName = "FINGPAY Banking page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private FINGPAYBankingPage wFINGPAYBankingPage;
	private Map<String, String> usrData;
	public String sheetname = "FINGPAYBankingPage", workbook = "WebAppUITestData";
	...
	public void fINGPAYBankingTest(HashMap<String, String> usrData)
		...
		wFINGPAYBankingPage = new FINGPAYBankingPage(wdriver);
		wFINGPAYBankingPage.fingpayBanking(usrData);
