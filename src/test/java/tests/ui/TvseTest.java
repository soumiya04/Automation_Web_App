...
import in.novopay.platform_ui.pages.web.TvsePage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class TvseTest {
	String featureName = "Tvse page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	

	private TvsePage wTvsePage;
	private Map<String, String> usrData;
	public String sheetname = "TvsePage", workbook = "WebAppUITestData";
	...
	public void tvseTest(HashMap<String, String> usrData)
		...
		wTvsePage = new TvsePage(wdriver);
		wTvsePage.tvse(usrData);
	}
