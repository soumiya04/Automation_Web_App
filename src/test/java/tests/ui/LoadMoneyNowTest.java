...
public class LoadMoneyNowTest {
	String featureName = "Load Money Now Page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private LoadMoneyNowPage wLoadMoneyNowPage;
	private Map<String, String> usrData;
	public String sheetname = "LoadMoneyNowPage", workbook = "WebAppUITestData";
	...
	public void loadMoneyNowTest(HashMap<String, String> usrData)
		...
		wLoadMoneyNowPage = new LoadMoneyNowPage(wdriver);
		wLoadMoneyNowPage.loadMoneyNow(usrData);
	}
