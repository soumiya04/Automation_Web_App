...
import in.novopay.platform_ui.pages.web.NSDLBankingPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class NSDLBankingTest {
	String featureName = "NSDL Banking page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private NSDLBankingPage wNSDLBankingPage;
	private Map<String, String> usrData;
	public String sheetname = "NSDLBankingPage", workbook = "WebAppUITestData";
	...
	public void nSDLBankingTest(HashMap<String, String> usrData)
		...
		wNSDLBankingPage = new NSDLBankingPage(wdriver);
		wNSDLBankingPage.nsdlBanking(usrData);
