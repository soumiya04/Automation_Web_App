...
import in.novopay.platform_ui.pages.web.FOPWalletLoadPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class FOPWalletLoadTest {
	String featureName = "FOP Wallet Load page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private FOPWalletLoadPage wFOPWalletLoadPage;
	private Map<String, String> usrData;
	public String sheetname = "FOPWalletLoadPage", workbook = "WebAppUITestData";
	...
	public void fOPWalletLoadTest(HashMap<String, String> usrData)
