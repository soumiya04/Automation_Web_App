...
import in.novopay.platform_ui.pages.web.FingpayYblYblPage;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class FingpayYblYblTest {

	String featureName = "FingpayYblYbl Banking page";
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private FingpayYblYblPage wFingpayYblYblPage;
	private Map<String, String> usrData;
	public String sheetname = "FingpayYblYblPage", workbook = "WebAppUITestData";
	...
	public void yBLBankingTest(HashMap<String, String> usrData)
		...
		wFingpayYblYblPage = new FingpayYblYblPage(wdriver);
		wFingpayYblYblPage.FingpayYblYbl(usrData);
